        ...
        <g id="style=bulk">
          ...
          <g id="menu-hamburger">
            ...
            <path
              ...
              fillRule="evenodd"
              clipRule="evenodd"
              d="M4.25 12.25C4.25 11.8358 4.51691 11.5 4.84615 11.5H19.1538C19.4831 11.5 19.75 11.8358 19.75 12.25C19.75 12.6642 19.4831 13 19.1538 13H4.84615C4.51691 13 4.25 12.6642 4.25 12.25Z"
              fill="#000000"
            ></path>{" "}
            <path
              id="vector (Stroke)_3"
